# app/workflow/supervision/supervisor.py
"""
...
from app.workflow.prompt_adapter import PromptAdapter
from app.workflow.engine_v2.llm_output_integrity import LLMOutputIntegrity
...
async def marcus_supervise(
    ...
    from app.workflow.tiered_review import get_review_level, ReviewLevel
...
async def supervised_agent_call(
    ...
    for attempt in range(1, max_retries + 1):
        ...
        try:
            ...
            from app.workflow.supervision.quality_gate import check_quality_gate
