...
5. **BACKEND TESTING PATTERNS** (CRITICAL):
   ...
   - ✅ `test_contract_api.py` exists and covers base CRUD (DO NOT MODIFY)
   - ✅ `test_capability_api.py` covers advanced logic/edge cases (generated by Derek)
   
   📋 TEST STRATEGY:
   - Contract tests are immutable and define the baseline.
   - Capability tests explores business logic and edge cases.
   - Derek customizes capability tests for the project's primary entity
